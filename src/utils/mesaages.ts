const messages: Record<string, string>  = {
    ...
    "requestPrompt":"Please provide a brief description or information about the background of image you've uploaded.",
...
export function getReplyMessage(messageOption: string, credits:Number | undefined = undefined): string{
    if(credits){
